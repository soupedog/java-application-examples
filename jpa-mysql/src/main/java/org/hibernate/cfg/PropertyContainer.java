...
class PropertyContainer {
    ...
    {
        System.out.println(String.format("String-%s", String.class.getClassLoader()));
        System.out.println(String.format("PropertyContainer-%s", this.getClass().getClassLoader()));
    }
